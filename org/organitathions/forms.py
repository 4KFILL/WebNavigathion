...
from string import ascii_uppercase, digits, punctuation as punc
...
class OrgTagForm(ModelForm):
    class Meta:
        ...
        if Tag.objects.count() < 3:
            widgets = {
                'title': forms.Textarea(attrs={'class': 'form-control', "placeholder": "\n".join(Tag.objects.values_list('title', flat=True))}),
            }
